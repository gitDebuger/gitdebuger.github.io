import{_ as n,c as a,e,o as l}from"./app-CNYnZXky.js";const i={};function p(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="lab0实验报告" tabindex="-1"><a class="header-anchor" href="#lab0实验报告"><span>Lab0实验报告</span></a></h1><h2 id="思考题" tabindex="-1"><a class="header-anchor" href="#思考题"><span>思考题</span></a></h2><h3 id="thinking-0-1" tabindex="-1"><a class="header-anchor" href="#thinking-0-1"><span>Thinking 0.1</span></a></h3><p>思考下列有关Git的问题。</p><p>依次执行命令：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line"><span class="token function">touch</span> README.txt</span>
